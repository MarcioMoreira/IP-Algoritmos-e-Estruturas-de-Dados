...
public class ArrayQueue<E> implements Queue<E>, Cloneable, Iterable<E> {
	...
	/**
	 * The index of the front of the queue, that is, 
	 * of the first element to exit the queue.
	 */
	private int head;

	/**
	 * The index of the tail of the queue, that is,
	 * where the next element will be stored.
	 */
	private int tail;
	...
	private boolean equalQueues_(ArrayQueue<E> other) {
		ArrayQueue<E> first = (ArrayQueue<E>) this.clone(), 
				      second = (ArrayQueue<E>) other.clone();
